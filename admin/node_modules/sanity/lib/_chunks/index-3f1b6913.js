...
var desk = require('./desk-c311cba8.js');
...
const ReferenceChangedBanner = React.memo(() => {
  ...
  const referenceInfo = reactRx.useMemoObservable(() => {
    ...
    return rxjs.concat(rxjs.of({
      ...
      _type: "reference",
      _ref: publishedId
    }, keyedSegmentIndex === -1 ? path : path.slice(0, keyedSegmentIndex)).pipe(operators.debounceTime(750), operators.map(_ref25 => {
      let {
        draft,
        published
      } = _ref25;
...
function DocumentHeaderTitle() {
  ...
  const {
    error,
    value
  } = sanity.unstable_useDocumentPreview({
    enabled: subscribed,
    schemaType,
    value: documentValue
  });
...
function ModalDialog(props) {
  ...
  const footer = modal.footer && /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
    paddingX: 4,
    paddingY: 3,
...
function ActionMenuButton(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
    ...
    }), currentAction && currentAction.modal && /* @__PURE__ */jsxRuntime.jsx(sanity.LegacyLayerProvider, {
      zOffset: "paneFooter",
...
function DocumentStatusBarActionsInner(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
    ...
    }), firstActionState && firstActionState.modal && /* @__PURE__ */jsxRuntime.jsx(ActionStateDialog, {
...
function KeyboardShortcutResponder(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(desk.Pane, _objectSpread(_objectSpread({
    ...
    ref: rootRef,
    children: [children, activeAction && activeAction.modal && /* @__PURE__ */jsxRuntime.jsx(sanity.LegacyLayerProvider, {
      zOffset: "paneFooter",
      children: /* @__PURE__ */jsxRuntime.jsx(ActionStateDialog, {
...
function InnerDocumentPane() {
  ...
  const footer = React.useMemo(() => /* @__PURE__ */jsxRuntime.jsx(desk.PaneFooter, {
...
//# sourceMappingURL=index-3f1b6913.js.map
