...
const DiscardChangesAction = _ref22 => {
  ...
  const modal = React.useMemo(() => isConfirmDialogOpen && {
    type: "confirm",
    tone: "critical",
    onCancel: onComplete,
    onConfirm: handleConfirm,
...
const deskTool = sanity.createPlugin(options => ({
  ...
  tools: [{
    ...
    component: React.lazy(() => Promise.resolve().then(function () {
      return require('./index-3f1b6913.js');
    }).then(function (n) {
      return n.index;
    })),
...
//# sourceMappingURL=desk-c311cba8.js.map
