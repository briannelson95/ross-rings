...
import { useSchema, unstable_useDocumentPreview, useTimeAgo, createHookFromObservableFactory, getDraftId, getPublishedId, useClient, DEFAULT_STUDIO_CLIENT_OPTIONS, useDocumentStore, TextWithTone, isRecord, getPreviewStateObservable, SanityDefaultPreview, getPreviewValueWithFallback, DocumentPreviewPresence, useUnique, useDocumentPresence, useDocumentPreviewStore, PreviewCard, LegacyLayerProvider, useCurrentUser, InsufficientPermissionsMessage, useTemplates, useTemplatePermissions, useDocumentOperation, useDocumentPairPermissions, useValidationStatus, useSyncState, useEditState, createPlugin, getConfigContextFromSource, useSource, useConfigContextFromSource } from 'sanity';
...
const deskTool = createPlugin(options => ({
  ...
  tools: [{
    ...
    component: lazy(() => import('./index-9c7f844d.esm.js').then(function (n) {
      return n.i;
    })),
...
//# sourceMappingURL=desk-2acb4362.esm.js.map
