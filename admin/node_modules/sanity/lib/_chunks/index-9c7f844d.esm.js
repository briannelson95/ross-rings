...
const paneMap = {
  component: lazy(() => import('./index-5619599b.esm.js')),
  document: lazy(() => import('./index-bbc342d5.esm.js')),
  documentList: lazy(() => import('./index-3b38d142.esm.js')),
  list: lazy(() => import('./index-2bfdeb06.esm.js'))
};
...
const ReferenceChangedBanner = memo(() => {
  ...
  const referenceInfo = useMemoObservable(() => {
    ...
    return concat(of({
      ...
      _type: "reference",
      _ref: publishedId
    }, keyedSegmentIndex === -1 ? path : path.slice(0, keyedSegmentIndex)).pipe(debounceTime(750), map(_ref25 => {
      let {
        draft,
        published
      } = _ref25;
...
function ModalDialog(props) {
  ...
  const modalId = useId();
  const footer = modal.footer && /* @__PURE__ */jsx(Box, {
    paddingX: 4,
    paddingY: 3,
  ...
  return /* @__PURE__ */jsx(LegacyLayerProvider, {
    ...
    children: /* @__PURE__ */jsx(Dialog, {
      ...
      width: modal.width === void 0 ? 1 : DIALOG_WIDTH_TO_UI_WIDTH[modal.width],
      children: /* @__PURE__ */jsx(Box, {
        padding: 4,
...
function ActionMenuButton(props) {
  ...
  return /* @__PURE__ */jsxs(Fragment, {
    ...
    }), currentAction && currentAction.modal && /* @__PURE__ */jsx(LegacyLayerProvider, {
      zOffset: "paneFooter",
...
function DocumentStatusBarActionsInner(props) {
  ...
  return /* @__PURE__ */jsxs(Flex, {
    ...
    }), firstActionState && firstActionState.modal && /* @__PURE__ */jsx(ActionStateDialog, {
...
function KeyboardShortcutResponder(props) {
  ...
  return /* @__PURE__ */jsxs(Pane, _objectSpread(_objectSpread({
    ...
    ref: rootRef,
    children: [children, activeAction && activeAction.modal && /* @__PURE__ */jsx(LegacyLayerProvider, {
      zOffset: "paneFooter",
      children: /* @__PURE__ */jsx(ActionStateDialog, {
...
function InnerDocumentPane() {
  ...
  const footer = useMemo(() => /* @__PURE__ */jsx(PaneFooter, {
...
//# sourceMappingURL=index-9c7f844d.esm.js.map
