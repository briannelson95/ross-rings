...
/** @beta */
declare interface DocumentActionConfirmModalProps {
  type: 'confirm'
  tone?: ButtonTone
...
/** @beta */
declare interface DocumentActionDialogModalProps {
  type: 'dialog'
...
/** @beta */
declare interface ObjectFieldProps<T = {[key in string]: unknown}> extends BaseFieldProps {
  schemaType: ObjectSchemaType
...
/** @beta */
declare type RenderPreviewCallback = (props: Omit<PreviewProps, 'renderDefault'>) => ReactNode
