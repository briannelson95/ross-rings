 ...
 * @internal
 */
export declare function ArrayOfObjectsMembers(props: ArrayOfObjectsMembersProps): JSX.Element

/** @internal */
export declare interface ArrayOfObjectsMembersProps {
  members: ArrayOfObjectsMember[]
  renderInput: RenderInputCallback
  renderField: RenderFieldCallback
  renderItem: RenderArrayOfObjectsItemCallback
...
/** @beta */
export declare interface DocumentActionConfirmModalProps {
  type: 'confirm'
  tone?: ButtonTone
...
/** @beta */
export declare interface DocumentActionDialogModalProps {
  type: 'dialog'
...
/** @beta */
export declare type DocumentActionModalProps =
  | DocumentActionConfirmModalProps
  | DocumentActionPopoverModalProps
  | DocumentActionDialogModalProps

/** @beta */
export declare interface DocumentActionPopoverModalProps {
  type: 'popover'
  content: React_2.ReactNode
  onClose: () => void
}
...
/** @beta */
export declare type MediaPreviewProps = PreviewProps<'media'>
...
/** @beta */
export declare interface ObjectFieldProps<
  T = {
    [key in string]: unknown
  }
 ...
 * @internal
 */
export declare function ObjectMembers(props: ObjectMembersProps): JSX.Element
...
/** @beta */
export declare type RenderPreviewCallback = (
  props: Omit<PreviewProps, 'renderDefault'>
) => ReactNode
...
/** @internal */
export declare interface SanityDefaultPreviewProps
...
/** @internal */
export declare function SanityPreview(
...
/** @internal */
export declare interface SanityPreviewProps
  extends Omit<PreviewProps, 'value' | 'renderDefault' | 'schemaType'> {
 ...
 */
export declare function unstable_useDocumentPreview(props: {
  enabled?: boolean
  ordering?: SortOrdering
  schemaType?: SchemaType
